      ...
      build: (pw.Context context) => [
        ...
        pw.Container(
          ...
          child: pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
            ...
            pw.Text('Medication Adherence Report', style: const pw.TextStyle(color: PdfColors.white70, fontSize: 16)),
  ...
  pw.Widget _pdfStatBox(String label, String value, PdfColor color) {
    return pw.Expanded(child: pw.Container(
      ...
      child: pw.Column(children: [
        ...
        pw.Text(label, style: const pw.TextStyle(color: PdfColors.white70, fontSize: 11)),
      ]),
    ));
  }
